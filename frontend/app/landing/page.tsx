    ...
    <div className="min-h-screen bg-white">
          ...
          <div className="flex justify-between items-center h-16">
            ...
            <div className="hidden md:block">
              <div className="ml-10 flex items-baseline space-x-8">
                ...
                <a href="#events" className="text-gray-700 hover:text-blue-600 px-3 py-2 text-sm font-medium cursor-pointer">Events</a>
            ...
            <div className="hidden md:flex items-center space-x-4">
              <Link href="/dashboard" className="bg-blue-600 hover:bg-blue-700 text-white px-4 py-2 rounded-lg text-sm font-medium cursor-pointer whitespace-nowrap">
                Member Login
              </Link>
            </div>
        ...
        {isMenuOpen && (
          <div className="md:hidden">
            <div className="px-2 pt-2 pb-3 space-y-1 sm:px-3 bg-white border-t">
              <a href="#home" className="block px-3 py-2 text-gray-900 hover:text-blue-600 cursor-pointer">Home</a>
              <a href="#about" className="block px-3 py-2 text-gray-700 hover:text-blue-600 cursor-pointer">About</a>
              <a href="#services" className="block px-3 py-2 text-gray-700 hover:text-blue-600 cursor-pointer">Services</a>
              <a href="#events" className="block px-3 py-2 text-gray-700 hover:text-blue-600 cursor-pointer">Events</a>
              <a href="#contact" className="block px-3 py-2 text-gray-700 hover:text-blue-600 cursor-pointer">Contact</a>
              <Link href="/dashboard" className="block px-3 py-2 bg-blue-600 text-white rounded-lg cursor-pointer whitespace-nowrap">
                Member Login
              </Link>
            </div>
          </div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 w-full">
          <div className="text-center text-white">
            ...
            <div className="flex flex-col sm:flex-row justify-center gap-4">
              <Link href="/dashboard" className="bg-blue-600 hover:bg-blue-700 text-white px-8 py-4 rounded-lg text-lg font-semibold cursor-pointer whitespace-nowrap">
                Join Our Community
              </Link>
      ...
      <section className="bg-blue-600 py-16">
        <div className="max-w-4xl mx-auto text-center px-4 sm:px-6 lg:px-8">
          ...
          <div className="flex flex-col sm:flex-row justify-center gap-4">
            <Link href="/dashboard" className="bg-white text-blue-600 hover:bg-gray-100 px-8 py-4 rounded-lg text-lg font-semibold cursor-pointer whitespace-nowrap">
              Member Login
            </Link>
          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
            ...
            <div>
              ...
              <ul className="space-y-2">
                <li><a href="#about" className="text-gray-300 hover:text-white cursor-pointer">About Us</a></li>
                <li><a href="#services" className="text-gray-300 hover:text-white cursor-pointer">Services</a></li>
                <li><a href="#events" className="text-gray-300 hover:text-white cursor-pointer">Events</a></li>
                <li><Link href="/dashboard" className="text-gray-300 hover:text-white cursor-pointer">Member Portal</Link></li>
              </ul>
            </div>
